...
# source: app/udaconnect/grpc_services/person-service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='app/udaconnect/grpc_services/person-service.proto',
  package='',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n1app/udaconnect/grpc_services/person-service.proto\"\x07\n\x05\x45mpty\"!\n\x13UniquePersonMessage\x12\n\n\x02id\x18\x01 \x01(\x05\"X\n\rPersonMessage\x12\n\n\x02id\x18\x01 \x01(\x05\x12\x12\n\nfirst_name\x18\x02 \x01(\t\x12\x11\n\tlast_name\x18\x03 \x01(\t\x12\x14\n\x0c\x63ompany_name\x18\x04 \x01(\t\"8\n\x11PersonMessageList\x12#\n\x0bperson_list\x18\x01 \x03(\x0b\x32\x0e.PersonMessage2\x8c\x01\n\rPersonService\x12(\n\x06\x43reate\x12\x0e.PersonMessage\x1a\x0e.PersonMessage\x12+\n\x03Get\x12\x14.UniquePersonMessage\x1a\x0e.PersonMessage\x12$\n\x06GetAll\x12\x06.Empty\x1a\x12.PersonMessageListb\x06proto3'
)
...
_UNIQUEPERSONMESSAGE = _descriptor.Descriptor(
  name='UniquePersonMessage',
  full_name='UniquePersonMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='UniquePersonMessage.id', index=0,
...
_PERSONMESSAGELIST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='person_list', full_name='PersonMessageList.person_list', index=0,
...
_PERSONMESSAGELIST.fields_by_name['person_list'].message_type = _PERSONMESSAGE
DESCRIPTOR.message_types_by_name['Empty'] = _EMPTY
DESCRIPTOR.message_types_by_name['UniquePersonMessage'] = _UNIQUEPERSONMESSAGE
...
Empty = _reflection.GeneratedProtocolMessageType('Empty', (_message.Message,), {
  'DESCRIPTOR' : _EMPTY,
  '__module__' : 'app.udaconnect.grpc_services.person_service_pb2'
  # @@protoc_insertion_point(class_scope:Empty)
  })
_sym_db.RegisterMessage(Empty)

UniquePersonMessage = _reflection.GeneratedProtocolMessageType('UniquePersonMessage', (_message.Message,), {
  'DESCRIPTOR' : _UNIQUEPERSONMESSAGE,
  '__module__' : 'app.udaconnect.grpc_services.person_service_pb2'
  # @@protoc_insertion_point(class_scope:UniquePersonMessage)
  })
_sym_db.RegisterMessage(UniquePersonMessage)
...
_PERSONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    index=1,
    containing_service=None,
    input_type=_UNIQUEPERSONMESSAGE,
    output_type=_PERSONMESSAGE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
